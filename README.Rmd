...
```{r pressure, echo=FALSE, fig.cap="A caption", out.width = '30%',fig.align='center'}
knitr::include_graphics("/Users/atakankiziltan/Desktop/calisma klasoru r/dataflair_ideas/imgfile.png")
```
...
You can install the released version of MAKibb from [CRAN](https://CRAN.R-project.org) with:
